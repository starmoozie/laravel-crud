...
@endforeach
  ...
  <!--  This is where modal fields assets are pushed.
        ...
        so we make sure all starmoozie assets are previously loaded, like jquery etc.

        We can give the same stack name because starmoozie `crud_fields_scripts` is already rendered and
