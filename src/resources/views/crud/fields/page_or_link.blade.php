<!-- PAGE OR LINK field -->
<!-- Used in Starmoozie\MenuCRUD -->

<?php
    $field['options'] = [
        'page_link'     => trans('starmoozie::crud.page_link'),
        'internal_link' => trans('starmoozie::crud.internal_link'),
        'external_link' => trans('starmoozie::crud.external_link'),
    ];
...
@include('crud::fields.inc.wrapper_start')
    ...
    echo 'd-none';
                ...
                <input
                    ...
                    class="form-control"
                    name="{!! $entry_link !!}"
                    placeholder="{{ trans('starmoozie::crud.page_link_placeholder') }}"
    ...
    echo 'd-none';
                ...
                <input
                    ...
                    class="form-control"
                    name="{!! $entry_link !!}"
                    placeholder="{{ trans('starmoozie::crud.internal_link_placeholder', ['url', url(config('starmoozie.base.route_prefix').'/page')]) }}"
