...
/**
 * @covers Starmoozie\CRUD\app\Library\CrudPanel\Traits\Columns
 */
class CrudPanelColumnsTest extends BaseDBCrudPanelTest
{
    ...
    private $expectedRelationColumnsArray = [
        'accountDetails' => [
            ...
            'model'       => 'Starmoozie\CRUD\Tests\Unit\Models\AccountDetails',
        ...
        'accountDetails__user' => [
            ...
            'model' => 'Starmoozie\CRUD\Tests\Unit\Models\User',
        ],
    ];
    ...
    private $expectedNestedRelationColumnArray = [
        'accountDetails__article' => [
            ...
            'model'       => 'Starmoozie\CRUD\Tests\Unit\Models\Article',
